...
public class laporanStokBarang extends javax.swing.JDialog {
        ...
        // Inner class untuk ReadOnlyTableModel
    ...
    public void tanggal(){
        // Contoh penggunaan tgl jika ingin menampilkan tanggal saat ini
        Date tgl = new Date();
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
        System.out.println("Tanggal saat ini: " + sdf.format(tgl));
        // Jika tidak perlu menampilkan, Anda dapat menghapus seluruh isi metode ini
    }
    ...
    public void dataTable(){
        ...
        try{
            ...
            while (hasil.next()){
                ...
                // Menggunakan SimpleDateFormat jika perlu mengubah format tanggal
                SimpleDateFormat fm = new SimpleDateFormat("dd-MM-yyyy");
                Date tanggalParsed = fm.parse(tanggal); // Pastikan tanggal dari DB dalam format yang sesuai
                String tanggalFormatted = fm.format(tanggalParsed);
                ...
                String[] data = {"", tanggalFormatted, kode_part, nama_part, kategori, jumlah, keterangan};
                tabmode.addRow(data);
                noTable();
                lebarKolom();
            }
