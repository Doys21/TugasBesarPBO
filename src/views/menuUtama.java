...
// penutup frame maks dan geser panel
     ...
     */
        ...
        private void initComponents() {
                ...
                panelUtama.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
                ...
                labelNama.setText("Aplikasi Toko Sparepart Motor Rizal");
                ...
                btnMaximize.setBackground(new java.awt.Color(204, 204, 255));
                btnMaximize.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8_Maximize_Window_30px.png"))); // NOI18N
                btnMaximize.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
                ...
                panelHeaderLayout.setHorizontalGroup(
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelHeaderLayout.createSequentialGroup()
                                .addComponent(labelNama, javax.swing.GroupLayout.DEFAULT_SIZE, 1551, Short.MAX_VALUE)
                                .addGap(0, 0, 0)
                ...
                panelMenu.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));

                btnMasterData.setBackground(new java.awt.Color(204, 204, 255));
                ...
                panelJam.setBackground(new java.awt.Color(204, 204, 255));

                tgl.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnDataBarang.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnDataSupplier.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnDataGudang.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnDataKategori.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnBarangMasuk.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnBarangKeluar.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnLapBarangMasuk.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnLapBarangKeluar.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnLapStokBarang.setBackground(new java.awt.Color(204, 204, 255));
                ...
                btnLapDataSupplier.setBackground(new java.awt.Color(204, 204, 255));
    ...
    private void btnDataBarangActionPerformed(java.awt.event.ActionEvent evt) {
        panelMasterData.setVisible(false);
        new dataBarang(this, rootPaneCheckingEnabled).setVisible(true);
    }    
    ...
    private void btnMasterDataMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnMasterDataMouseEntered
        ...
        btnMasterData.setBackground(new Color(204,204,255));
    ...
    private void btnTransaksiMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnTransaksiMouseEntered
        ...
        btnTransaksi.setBackground(new Color(204,204,255));
    ...
    private void btnLaporanMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLaporanMouseEntered
        ...
        btnLaporan.setBackground(new Color(204,204,255));
    ...
    private void btnDataBarangMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDataBarangMouseEntered
        ...
        btnDataBarang.setBackground(new Color(204,204,255));
    ...
    private void btnDataSupplierMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDataSupplierMouseEntered
        ...
        btnDataSupplier.setBackground(new Color(204,204,255));
    ...
    private void btnDataGudangMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDataGudangMouseEntered
        ...
        btnDataGudang.setBackground(new Color(204,204,255));
    ...
    private void btnDataKategoriMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnDataKategoriMouseEntered
        ...
        btnDataKategori.setBackground(new Color(204,204,255));
    ...
    private void btnBarangMasukMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBarangMasukMouseEntered
        ...
        btnBarangMasuk.setBackground(new Color(204,204,255));
    ...
    private void btnBarangKeluarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBarangKeluarMouseEntered
        ...
        btnBarangKeluar.setBackground(new Color(204,204,255));
    ...
    private void btnLapBarangMasukMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLapBarangMasukMouseEntered
        ...
        btnLapBarangMasuk.setBackground(new Color(204,204,255));
    ...
    private void btnLapBarangKeluarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLapBarangKeluarMouseEntered
        ...
        btnLapBarangKeluar.setBackground(new Color(204,204,255));
    ...
    private void btnLapStokBarangMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLapStokBarangMouseEntered
        ...
        btnLapStokBarang.setBackground(new Color(204,204,255));
    ...
    private void btnDataKategoriActionPerformed(java.awt.event.ActionEvent evt) {
        panelMasterData.setVisible(false);
        new dataKategori(this, rootPaneCheckingEnabled).setVisible(true);
    }    

    private void btnMaximizeMouseClicked(java.awt.event.MouseEvent evt) {
        // Jika saat ini window tidak dimaksimalkan
        if(!maximixed) {
            // Maksimalkan window
            ...
            maximixed = true; // Perbarui status menjadi 'dimaksimalkan'
        } else {
            // Jika window saat ini dimaksimalkan, kembalikan ke ukuran normal
            menuUtama.this.setExtendedState(JFrame.NORMAL);
            maximixed = false; // Perbarui status menjadi 'tidak dimaksimalkan'
        }
    }
    ...
    private void btnDataGudangActionPerformed(java.awt.event.ActionEvent evt) {
        panelMasterData.setVisible(false);
        new dataGudang(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnDataSupplierActionPerformed(java.awt.event.ActionEvent evt) {
        panelMasterData.setVisible(false);
        new dataSupplier(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnBarangMasukActionPerformed(java.awt.event.ActionEvent evt) {
        panelTransaksi.setVisible(false);
        new transaksiBarangMasuk(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnBarangKeluarActionPerformed(java.awt.event.ActionEvent evt) {
        panelTransaksi.setVisible(false);
        new transaksiBarangKeluar(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnLapBarangMasukActionPerformed(java.awt.event.ActionEvent evt) {
        panelLaporan.setVisible(false);
        new laporanBarangMasuk(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnLapBarangKeluarActionPerformed(java.awt.event.ActionEvent evt) {
        panelLaporan.setVisible(false);
        new laporanBarangKeluar(this, rootPaneCheckingEnabled).setVisible(true);
    }
    
    private void btnLapStokBarangActionPerformed(java.awt.event.ActionEvent evt) {
        panelLaporan.setVisible(false);
        new laporanStokBarang(this, rootPaneCheckingEnabled).setVisible(true);
    }    
    ...
    private void btnLapDataSupplierMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnLapDataSupplierMouseEntered
        ...
        btnLapDataSupplier.setBackground(new Color(204,204,255));
    ...
    private void btnLapDataSupplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLapDataSupplierActionPerformed
        panelLaporan.setVisible(false);
        laporanDataSupplier laporan = new laporanDataSupplier(this, rootPaneCheckingEnabled);
