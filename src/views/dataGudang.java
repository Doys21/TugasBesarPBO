...
public class dataGudang extends javax.swing.JDialog {
    ...
    public void pencarian(String sql){
        ...
        try {
            ...
            while (hasil.next()){
                ...
                String[] data = {"", tanggal, kode_gudang, nama_gudang, alamat, keterangan};
                tabmode.addRow(data);
                noTable(); // Pastikan metode noTable() melakukan fungsinya dengan benar
            }
        } catch(Exception e){
            // Sebaiknya menangani atau mencatat exception ini
        }
    }
    ...
    private void tabelGudangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelGudangMouseClicked
        ...
        txtKodeGudang.setText(a);
        txtNamaGudang.setText(b);
        txtAlamat.setText(c);
